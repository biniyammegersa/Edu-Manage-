import Login from "@/components/auth-component/signin";
...
export const metadata = {
  ...
  description:
    "Sign in to EduManage — your university project management platform.",
};
          ...
          <div className="hidden lg:flex lg:col-span-5 flex-col justify-between bg-gradient-to-br from-[#0f766e] via-[#1a9e7a] to-[#34d399] p-12 text-white relative overflow-hidden">
            ...
            <div className="z-10 space-y-6 my-auto py-8">
              <h1 className="text-3xl font-extrabold leading-tight">
                ...
                <span className="text-emerald-200 font-black">Effortlessly</span>
              </h1>
              <p className="text-emerald-100 text-sm leading-relaxed">
                From proposal submission to final showcase — everything your
                university project journey needs, in one platform.
              </p>
